...
| grafana-legacy.enabled | bool | `false` | Enable or disable Grafana deployment |
| grafana-legacy.ingress | object | `{"annotations":{},"enabled":false,"hostName":"","ingressClassName":"haproxy"}` | Ingress configuration for Grafana |
| grafana-legacy.ingress.enabled | bool | `false` | Enable or disable ingress for Grafana |
| grafana-legacy.ingress.hostName | string | `""` | Hostname for Grafana ingress |
| grafana-legacy.ingress.ingressClassName | string | `"haproxy"` | Ingress class name (e.g. nginx, haproxy) |
| grafana-legacy.ingress.annotations | object | `{}` | Additional annotations for Grafana ingress |
