...
| scaleFromZero.admissionImage | string | `"python:3.14-slim"` | Image for the admission sidecar on the Envoy pod |
...
| inferenceServer.image | string | `"nvcr.io/nvidia/tritonserver:26.08-py3-min"` | Docker image for the inference server |
...
| envoy.image | string | `"envoyproxy/envoy:v1.39.1"` | Envoy Proxy Docker image |
...
| metricsCollector.image | string | `"python:3.14-slim"` | Image for the metrics collector |
