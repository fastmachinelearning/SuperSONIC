...
| common.envoyService | object | "" | Configuration of Kubernetes Service associated with Envoy Proxy. This Service connects outside world to Envoy Proxy, either directly or via an Ingress in front of it. |
...
| common.tritonService | object | "" | Configuration of Kubernetes Services associated with Triton Deployments |
